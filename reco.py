...
# Converting genres, keywords, cast, crew into list of names
def convert(text):
    l = []
    for i in ast.literal_eval(text):
        l.append(i['name'])
...
# Creating tags by combining relevant columns
movies['tags'] = movies['genres'] + movies['overview'] + movies['cast'] + movies['crew'] + movies['keywords']
new_data = movies[['movie_id', 'title', 'tags']]

# Converting tags to string and lowercasing
